...
#function for loading background image in rendered environment
def load_bg_img(path_to_img, w, h):
    bg_img = cv2.imread(path_to_img, cv2.IMREAD_COLOR) #this helps assign the desired image to bg_img
    bg_img = cv2.cvtColor(bg_img, cv2.COLOR_BGR2RGB) #this helps convert or change the colour of the image to rgb
    bg_img = cv2.resize(bg_img, (w, h)) #this helps resize the image to the desired size.
    return bg_img

#function for creating a list of 50 points on the circumference of a circle
...
#function for creating a list of 50 points on the circumference of an ellipse
...
#function for creating a list of the coordinates of the corners of a rectangle.
